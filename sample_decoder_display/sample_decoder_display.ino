...
void parseAndDisplay(String canMessage) {
  // Replace with your logic to extract and display relevant information
  // For example, you can extract and display vehicle speed from the given data

  // Example: Displaying the ID and Bytes 1 & 2
